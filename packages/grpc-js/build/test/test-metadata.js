...
const validNonBinValueChars = lodash_1.range(0x20, 0x7f)
...
describe('Metadata', () => {
    ...
    describe('toHttp2Headers', () => {
        it('creates an OutgoingHttpHeaders object with expected values', () => {
            ...
            metadata.add('KEY3', 'value3a');
            metadata.add('key3', 'value3b');
            metadata.add('key-bin', Buffer.from(lodash_1.range(0, 16)));
            metadata.add('key-bin', Buffer.from(lodash_1.range(16, 32)));
            metadata.add('key-bin', Buffer.from(lodash_1.range(0, 32)));
        ...
        it('creates a Metadata object with expected values', () => {
            ...
            const expected = new Map([
                ...
                [
                    'key-bin',
                    [
                        Buffer.from(lodash_1.range(0, 16)),
                        Buffer.from(lodash_1.range(16, 32)),
                        Buffer.from(lodash_1.range(0, 32)),
                    ],
                ],
            ]);
